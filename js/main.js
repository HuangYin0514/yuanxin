(function ($) {
    ...
    if (frameload.length) {
        ...
        frameload.empty().append("<div style='height: " + winHeight + "px;width: 100%;position: absolute;z-index: 2;'><img src='img/t4.png'/*tpa=http://www.qsjqj.com/js/img/t4.png*/ class='img-responsive center-block notransition animated fadeInUpNow animation103' style='margin-top: " + winHeight / 2 + "px;padding-left: 20px;padding-right: 20px;'></div> <iframe frameborder='0' width='100%' scrolling='no'style='margin: 0 auto;z-index: 0'height=" + winHeight + " src='http://www.qsjqj.com/js/pano/index.html'></iframe>");
    }
    // $("#footer").load("http://www.qsjqj.com/js/footer.html");
    /*===================================================================================*/
    /*	缓慢滑动
     /*===================================================================================*/
    ...
    var wximgUrl = "../../www.luobotetian.com/img/weixin.png"/*tpa=http://www.luobotetian.com/img/weixin.png*/;
    $.ajax({
        async: false,
